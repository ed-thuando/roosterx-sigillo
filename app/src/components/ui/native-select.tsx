...
const nativeSelectVariants = cva(
  "relative inline-flex min-h-9 w-full min-w-36 items-center rounded-lg border border-border bg-background px-[calc(--spacing(3)-1px)] pr-8 text-left text-base text-foreground shadow-none outline-none ring-ring/24 transition-shadow focus-visible:border-ring focus-visible:ring-[3px] disabled:pointer-events-none disabled:opacity-64 sm:min-h-8 sm:text-sm",
)
